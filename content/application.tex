...
\begin{frame}[t]{Echo-aware Application \hfill\faBook}
    ...
    \begin{block}{Echoes: same content, different time/direction}
        \centering
        \only<1>{\includegraphics[width=0.5\textwidth]{figures/image_src_mic(0).png}}%
        \only<2>{\includegraphics[width=0.5\textwidth]{figures/image_src_mic(1).png}}%
        \only<3>{\includegraphics[width=0.5\textwidth]{figures/image_src_mic(2).png}}%
        \only<4->{\includegraphics[width=0.5\textwidth]{figures/image_src_mic(3).png}}%
    \end{block}
