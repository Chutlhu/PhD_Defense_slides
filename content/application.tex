...
\begin{frame}{Sound Source Localization \alert{with Echoes} \hfill\faMapMarked*}
    ...
    \begin{column}{0.5\textwidth}
        \centering
            \adjincludegraphics[Clip={0.5\width} {0\height} {0\width} {0\height},width=0.9\textwidth]{figures/mirage.png}
        \end{column}
    \end{columns}
...
\begin{frame}{\faFlask~Experimental results \hfill\faMapMarked*}
    ...
    \textbf{Observation}
        \begin{itemize}
            ...
            \item<5->[\cmark] \pro{Solved ``impossible'' localization}
            \item<6->[\iconAlert] Performance depending on echo estimation methods
        \end{itemize}
