...
\begin{frame}[t]{\blaster - Experimental Results}
    ...
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \only<1>{\includegraphics[width=0.9\textwidth]{figures/aer_scenario1.png}}
            \only<2>{\includegraphics[width=0.9\textwidth]{figures/aer_scenario2.png}}
            \only<3>{\includegraphics[width=0.9\textwidth]{figures/aer_scenario3.png}}
            \only<4>{\includegraphics[width=0.9\textwidth]{figures/aer_scenario4.png}}
        \end{column}
    \end{columns}
