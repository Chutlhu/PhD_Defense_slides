\begin{frame}[t]{Acoustic Echo Retrieval}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \includegraphics[width=.9\textwidth]{./figures/active-passive.png}
            ...
            \begin{block}{Passive approaches}
                ...
                \begin{itemize}
                    \small
                    \item \textbf{blind inverse} problem (harder)
                    \item \textbf{passive} listening
                    \item Time Difference of Arrivals (\textbf{TDOA}s) only
                    \\\hspace{.3em} \textbf{multi-mic}
                    \\\hspace{-1em}\textcolor{gray}{\footnotesize \textbf{Application} a-posteriori processing, smart speakers, ...}
                \end{itemize}
            \end{block}
            }
...
\begin{frame}[t]{Passive Acoustic Echo Estimation}
    ...
    \begin{block}{\alert{Passive} Acoustic Echo Estimation:}
        ...
        \begin{columns}[T,onlytextwidth] % align columns
            \begin{column}{.48\textwidth}
                Pros
                \begin{itemize}
                    \item SIMO BCE is well studied (eg. LASSO)% (elegant framework)
