...
\begin{frame}{Models \hfill\faBrain}
    ...
    \begin{center}
        \only<4>{\includegraphics[trim={0 0 0 20},clip,width=0.6\textwidth]{figures/dnn_mlp.png}}%
        \only<5>{\includegraphics[trim={0 0 0 20},clip,width=0.6\textwidth]{figures/dnn_cnn.png}}%
    \end{center}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \draw [decoration={brace,amplitude=0.35em},decorate,thick,gray]
         (a.north -| {pic cs:CNN}) -- node[right,inner sep=1em] {
             \small \parbox{12em}{for data fusion\\similar to \textbf{MDN}~{\footnotesize\cite{bishop1994mixture}}}
             } (b.south -| {pic cs:CNN});
    \end{tikzpicture}


    \vfill
    \footnotetext[1]{\tiny See appendix for detailed computation}
