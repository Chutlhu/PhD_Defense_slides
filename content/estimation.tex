...
\begin{frame}[t]{Acoustic Echo Retrieval \hfill\faBook}
    ...
    \begin{columns}[onlytextwidth]
        ...
        \begin{itemize}
            ...
            \\\addendum{\footnotesize \textbf{Applications:} sonar, calibration, measurements, etc.}
        \end{itemize}
    \end{columns}
    \end{block}
    ...
    \begin{mycontriblock}
        ...
        \begin{itemize}
            ...
            \\\addendum{\footnotesize \textbf{Applications:} recording on smart speakers, laptop, etc.}
        \end{itemize}
    \end{columns}
    \end{mycontriblock}
